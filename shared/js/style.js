let style = {
		...
		"sources": {
			'vector-tiles': {
				'type': 'vector',
				'tiles': ['http://localhost:8888/20220627-eu-rules-of-origin/gis/tilemaker-2.2.0/tileserver.php?/index.json?/ireland/{z}/{x}/{y}.pbf']
				//'tiles': ['http://ec2-34-244-25-30.eu-west-1.compute.amazonaws.com/tileserver-php/ukraine-sea-eng/{z}/{x}/{y}.pbf']
				
			}
		},
		"sprite": spriteURL,
		"glyphs": "https://interactive.guim.co.uk/maptiles/ukraine-100-days/fonts/{fontstack}/{range}.pbf",
		"layers":
		[
		{
			"id": "background",
